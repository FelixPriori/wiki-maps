...
const getUsersByEmail = function(db, userInfo){
...
module.exports = {getMaps, getUserWithName, getUsersByEmail, addUser, addMap, addPoints, getPointsByMap, getPointsByMapId};
